<template>
    <div class="sealUpCaseInPage"> 
        <div class="sealUpCaseInList">
    ...
    export default {
        ...
        methods: {
            ...
            stockExport() {
                ...
                var url = sessionStorage.getItem('baseURL')+`/juanzong/export/stockExport?stock_status=ZK&shale_type=2`
                arr.forEach((item)=>{
                    if(dataInfo[item]){
